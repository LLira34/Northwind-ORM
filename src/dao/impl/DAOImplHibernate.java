 ...
 * @param <ID>
 */
public class DAOImplHibernate<T, ID extends Serializable> implements DAO<T, ID> {

    SessionFactory sessionFactory;

    private final static Logger LOGGER = Logger.getLogger(DAOImplHibernate.class.getName());
